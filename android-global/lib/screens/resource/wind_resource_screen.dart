          ...
          children: [
            ...
            if (_showResults) ...[
              ...
              Container(
                ...
                padding: const EdgeInsets.all(16),
                child: BarChart(
                  data: MockData.windMonthlySpeed,
                  title: 'Monthly Average Speed (m/s)',
                ),
              ),
            ],
          ],
...
class WindRosePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      textPainter.layout();
      final offset = Offset(
        x + 5 - textPainter.width / 2,
        y + 5 - textPainter.height / 2,
      );
    ...
    for (int i = 0; i < 8; i++) {
      ...
      final p2 = Offset(
        center.dx + nextDist * math.cos(nextAngle),
        center.dy + nextDist * math.sin(nextAngle),
      );
      final p3 = Offset(
        center.dx + (radius * 0.1) * math.cos(nextAngle),
        center.dy + (radius * 0.1) * math.sin(nextAngle),
      );
      final p4 = Offset(
