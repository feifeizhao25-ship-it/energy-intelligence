  ...
  Widget _buildAnomalyCard(Map<String, dynamic> anomaly) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10),
        side: BorderSide(color: sevColor.withValues(alpha: 0.25), width: 1),
      ),
      child: Padding(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                _buildMetric(
                  'Deviation',
                  '${(anomaly['deviation'] as double).toStringAsFixed(1)}%',
                  color: sevColor,
                ),
              ],
            ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      'Est. loss: \$${((anomaly['estimatedLoss'] as double) / 1000).toStringAsFixed(1)}K/yr',
                      style: const TextStyle(
                        fontSize: 11,
                        color: Color(0xFFDC2626),
                      ),
