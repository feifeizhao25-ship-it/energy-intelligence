                ...
                <div className="p-6 flex-1 flex flex-col gap-6">
                  ...
                  <div className="mt-auto pt-4 border-t border-slate-50 flex items-center gap-2">
                    <Link
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-green-50 text-green-600 text-xs font-bold hover:bg-green-100 transition-colors"
                    >
                      <Activity className="w-4 h-4" />
                      运维
                    </Link>
                    <button className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-slate-50 text-slate-600 text-xs font-bold hover:bg-slate-100 transition-colors">
                      <BrainCircuit className="w-4 h-4 text-purple-500" />
                      诊断
                    </button>
                    <Link
                      href={`/projects/${project.id}`}
                      className="w-10 h-10 flex items-center justify-center rounded-xl bg-white border border-slate-200 text-slate-400 hover:border-green-500 hover:text-green-500 transition-all shadow-sm"
                    >
