...
function AddStationModal({ onClose }: { onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center">
            <div className="bg-white rounded-t-[32px] sm:rounded-[32px] w-full sm:max-w-md sm:mx-4 max-h-[90vh] flex flex-col">
                {/* Fixed Header */}
                <div className="flex justify-between items-center p-6 border-b border-slate-100">
                    <h2 className="text-xl font-black text-slate-900">添加电站</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 border-t border-slate-100 bg-white rounded-b-[32px]">
                    <button className="w-full bg-primary-500 text-white py-4 rounded-2xl font-bold hover:bg-primary-600 transition-colors shadow-primary">
                        保存电站
                    </button>
                </div>
            </div>
