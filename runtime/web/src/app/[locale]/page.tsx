...
export default function HomePage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-100 dark:border-slate-800">
                <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <Link href="#calculator" className="text-slate-600 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 text-sm font-medium">在线计算</Link>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <h1 className="text-4xl md:text-5xl font-black mb-6 leading-tight dark:text-white">
                                {t('hero.title')}<br />
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 shadow-2xl scroll-mt-20" id="calculator">
                            <div className="flex items-center gap-2 mb-6">
                                <CalcIcon className="w-6 h-6 text-green-500" />
                                <h2 className="text-xl font-bold text-slate-900 dark:text-white">快速发电量估算</h2>
                            </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none text-slate-900 dark:text-white placeholder:text-slate-400"
                                        />
            ...
            <section id="features" className="py-16 px-4 scroll-mt-20">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">核心功能</h2>
                        <p className="text-lg text-slate-500 dark:text-slate-400">专业级的新能源项目分析工具</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <Link
                                key={i}
                                href={feature.link}
                                className="group bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-xl hover:border-green-200 dark:hover:border-green-800 transition-all"
                            >
                                <div className={cn(
            ...
            {/* Pricing Preview */}
            <section className="py-16 px-4 bg-green-50 dark:bg-slate-950/50">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4">价格方案</h2>
                    <p className="text-lg text-slate-500 dark:text-slate-400 mb-8">从个人投资到企业级应用，满足不同规模需求</p>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className={cn(
                                ...
                                plan.popular ? "border-green-500" : "border-slate-100 dark:border-slate-700"
                            )}>
                                {plan.popular && (
                                ...
                                <div className="text-3xl font-black text-slate-900 dark:text-white mb-4">{plan.price}</div>
