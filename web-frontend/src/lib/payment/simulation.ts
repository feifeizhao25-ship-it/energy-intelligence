...
// Hard guard: mock payments must NEVER run in production.
// Simulated payment in production = de facto fraud (B3/EnergyIQ top safety gap).
if (typeof process !== 'undefined' && process.env?.NODE_ENV === 'production') {
    throw new Error('Mock payment module must never be imported in production builds.');
}
